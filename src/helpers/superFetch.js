 ...
 * if the method is form then don't send the json header
   sarebbe basicamente una fetch per ridurre 
   la quantità di codice da scrivere e includere anche 
   l'header dell'autenticazione.
